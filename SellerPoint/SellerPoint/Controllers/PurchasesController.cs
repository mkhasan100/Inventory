...
namespace SellerPoint.Controllers
{
    public class PurchasesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AccountHeadId,WarehouseId,WalletsId,SupplierId,PurchaseOrderDate,OrderNumber,OrderReferenceNumber,ProductAmount,OtherAmount,Discount,Total,ShippingProvider,ShippingTrackingNumber,Remarks")] Purchase purchase)
        {
